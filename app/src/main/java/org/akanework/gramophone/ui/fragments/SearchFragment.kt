...
class SearchFragment : BaseFragment(null) {
    ...
    override fun onCreateView(
        ...
        topAppBar.overflowIcon = AppCompatResources.getDrawable(
            ...
            setTint(
                MaterialColors.getColor(rootView, R.attr.contrast_themeColor)
            )
        }
        ...
        editText.addTextChangedListener { rawText ->
            ...
            if (rawText.isNullOrBlank()) {
                ...
                viewLifecycleOwner.lifecycleScope.launch(Dispatchers.Default) {
                    ...
                    filteredList.clear()
                    // Punctuation-insensitive, word-order-insensitive matching over title, artist,
                    // album and album artist - so "AR rahman" finds "A. R. Rahman" too.
                    val tokens = SearchMatcher.tokenize(text)
