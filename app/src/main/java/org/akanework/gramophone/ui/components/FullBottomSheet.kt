...
import org.akanework.gramophone.logic.getTimerRemaining
...
import org.akanework.gramophone.logic.takeNextQueueSlot
import org.akanework.gramophone.logic.ui.CustomSmoothScroller
import org.akanework.gramophone.logic.ui.coolCrossfade
import org.akanework.gramophone.logic.ui.fullPlayerOptionIds
import org.akanework.gramophone.logic.ui.goToAlbumOrArtistOptionIds
import org.akanework.gramophone.logic.ui.showSleepTimerSheet
import org.akanework.gramophone.logic.ui.showSongOptionsSheet
...
class FullBottomSheet @JvmOverloads constructor(
    ...
    // delayed pause (GramophonePlaybackService.timerDuration), no polling: the service just
    ...
    // continued into the next song) - it's passed through as GramophonePlaybackService's
    ...
    private fun sleepTimerRowValue(): String? {
        ...
        return when {
            duration == GramophonePlaybackService.TIMER_PAUSE_ON_SONG_END ->
    ...
    private fun openSleepTimerSheet() {
        showSleepTimerSheet(
            ...
            val resolved = durationMs ?: GramophonePlaybackService.TIMER_PAUSE_ON_SONG_END
