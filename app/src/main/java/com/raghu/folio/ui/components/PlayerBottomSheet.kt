...
import com.raghu.folio.logic.clone
import com.raghu.folio.logic.dpToPx
import com.raghu.folio.logic.getBooleanStrict
import com.raghu.folio.logic.playOrPause
import com.raghu.folio.logic.ui.MyBottomSheetBehavior
import com.raghu.folio.logic.utils.EnvUtils
import com.raghu.folio.logic.visibilityChanged
...
class PlayerBottomSheet private constructor(
    ...
    private val bottomSheetPreviewPreviousButton: MaterialButton
    ...
    init {
        ...
        this.backgroundTintList = ColorStateList.valueOf(
            MaterialColors.getColor(
                this,
                R.attr.contrast_colorBackgroundBottomNav
            )
        )
        ...
        bottomSheetPreviewPreviousButton = findViewById(R.id.preview_previous)
        ...
        bottomSheetPreviewPreviousButton.setOnClickListener {
            it.performHapticFeedback(HapticFeedbackConstants.CONTEXT_CLICK)
    ...
    override fun onStart(owner: LifecycleOwner) {
        super.onStart(owner)
        sessionToken =
            SessionToken(context, ComponentName(context, FolioPlaybackService::class.java))
        controllerFuture =
            MediaController
