...
class FolioExtractorsFactory : ExtractorsFactory {
	companion object {
	...
	@Synchronized
	fun setConstantBitrateSeekingEnabled(constantBitrateSeekingEnabled: Boolean): FolioExtractorsFactory {
		this.constantBitrateSeekingEnabled = constantBitrateSeekingEnabled
		return this
	}

	@Synchronized
	fun setConstantBitrateSeekingAlwaysEnabled(constantBitrateSeekingAlwaysEnabled: Boolean): FolioExtractorsFactory {
		this.constantBitrateSeekingAlwaysEnabled = constantBitrateSeekingAlwaysEnabled
		return this
	}

	@Synchronized
	fun setAdtsExtractorFlags(flags: Int): FolioExtractorsFactory {
		this.adtsFlags = flags
		return this
	}

	@Synchronized
	fun setFlacExtractorFlags(flags: Int): FolioExtractorsFactory {
		this.flacFlags = flags
		return this
	}

	@Synchronized
	fun setMatroskaExtractorFlags(flags: Int): FolioExtractorsFactory {
		this.matroskaFlags = flags
		return this
	}

	@Synchronized
	fun setMp4ExtractorFlags(flags: Int): FolioExtractorsFactory {
		this.mp4Flags = flags
		return this
	}

	@Synchronized
	fun setFragmentedMp4ExtractorFlags(flags: Int): FolioExtractorsFactory {
		this.fragmentedMp4Flags = flags
		return this
	}

	@Synchronized
	fun setMp3ExtractorFlags(flags: Int): FolioExtractorsFactory {
		this.mp3Flags = flags
		return this
	}
