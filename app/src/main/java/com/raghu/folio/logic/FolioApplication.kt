 ...
 */
class FolioApplication : Application(), SingletonImageLoader.Factory, Thread.UncaughtExceptionHandler {
    ...
    override fun onCreate() {
        ...
        // Only apply Material You dynamic colors when the user picked "Dynamic" in Appearance.
        // The theme overlay redirects our general-UI color tokens to the live M3 attributes;
        // the full player/lyrics screens don't use those tokens, so they're unaffected.
        DynamicColors.applyToActivitiesIfAvailable(this, DynamicColorsOptions.Builder()
            .setThemeOverlay(R.style.ThemeOverlay_App_Dynamic)
            .setPrecondition { activity, _ ->
                PreferenceManager.getDefaultSharedPreferences(activity)
                    .getString("theme_mode", "0") == "3"
            }
            .build())
