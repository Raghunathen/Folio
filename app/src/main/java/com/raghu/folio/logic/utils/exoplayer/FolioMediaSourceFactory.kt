package com.raghu.folio.logic.utils.exoplayer
...
class FolioMediaSourceFactory(
    ...
    constructor(dataSourceFactory: DataSource.Factory) : this(
        dataSourceFactory, FolioExtractorsFactory()
    )
    ...
    @UnstableApi
    fun setExternalImageLoader(externalImageLoader: ExternalLoader?): FolioMediaSourceFactory {
        this.externalImageLoader = externalImageLoader
        return this
    }

    @UnstableApi
    fun setLiveTargetOffsetMs(liveTargetOffsetMs: Long): FolioMediaSourceFactory {
        this.liveTargetOffsetMs = liveTargetOffsetMs
        return this
    }

    @UnstableApi
    fun setLiveMinOffsetMs(liveMinOffsetMs: Long): FolioMediaSourceFactory {
        this.liveMinOffsetMs = liveMinOffsetMs
        return this
    }

    @UnstableApi
    fun setLiveMaxOffsetMs(liveMaxOffsetMs: Long): FolioMediaSourceFactory {
        this.liveMaxOffsetMs = liveMaxOffsetMs
        return this
    }

    @UnstableApi
    fun setLiveMinSpeed(minSpeed: Float): FolioMediaSourceFactory {
        this.liveMinSpeed = minSpeed
        return this
    }

    @UnstableApi
    fun setLiveMaxSpeed(maxSpeed: Float): FolioMediaSourceFactory {
        this.liveMaxSpeed = maxSpeed
        return this
    }

    @UnstableApi
    override fun setCmcdConfigurationFactory(cmcdConfigurationFactory: CmcdConfiguration.Factory): FolioMediaSourceFactory {
    ...
    @UnstableApi
    override fun setLoadErrorHandlingPolicy(loadErrorHandlingPolicy: LoadErrorHandlingPolicy): FolioMediaSourceFactory {
